                ...
                if(msgType=== 'text'){
                    switch(content){
                        ...
                        case '趣事':
                            ...
                            小朱暗暗点头，觉得甚是有理，第二天小朱还去扔湿垃圾，结果猪死了，请问小朱第二天扔了什么垃圾？`.trim()
                            break;
                        case '投放时间':
                        ...
                        default: 
                            ...
                            if(!lsInfo){
                                lsInfo = `暂时未查询到您要查询的垃圾所属的分类，请检查您输入的关键词格式是否正确，例如：如果您要搜索的垃圾是"果皮"，请您直接输入 果皮 \n;
                                您也可
                                输入：“口诀”，查看垃圾分类的野口决；\n
                                输入: “互联网人”，查看互联网人的垃圾分类；\n
                                输入：“趣事”，查看垃圾分类趣事问答；\n
                                输入：“投放时间”，查看最新垃圾分类投放时间；`.trim()
                            }
                    ...
                    if(event === 'subscribe'){
                        ...
                        输入：您要查找的垃圾名称，例如 果皮，查看垃圾所属分类`.trim()                        
                    }
                }
