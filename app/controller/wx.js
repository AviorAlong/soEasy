                ...
                if(msgType=== 'text'){
                    switch(content){
                        ...
                        case '互联网人':
                            ...
                            break;
                        case '趣事':
                            lsInfo= `7月1日早晨，小朱去扔干垃圾，垃圾管理员小张放猪出去试吃，猪不吃，小张便给小朱开了第一张垃圾分类的罚单，罚金200元，小朱很是生气，
                            怒问凭什么开200的罚单，法律规定罚金在50-200之间，为什么不是开50；小张撇了撇嘴，行人违反道路交通安全法律，法律规定5-50元罚款，你见过哪个交警开5元的罚单了，
                            小朱暗暗点头，觉得甚是有理，第二天小朱还去扔湿垃圾，结果猪死了，请问小朱第二天扔了什么垃圾？`
                            break;
                        case '投放时间':
                            
                            lsInfo= `最新规定:上午7:00至9:00、下午5:30至7:30为投放时间`
                            break;
                        default: 
                            ...
                            if(!lsInfo){
                                ...
                                请检查您输入的关键词格式是否正确，例如：如果您要搜索的垃圾是"果皮"，请您直接输入 果皮;
                                您也可
                                输入：“口诀”，查看垃圾分类的野口决；
                                输入: “互联网人”，查看互联网人的垃圾分类；
                                输入：“趣事”，查看垃圾分类趣事问答；
                    ...
                    if(event === 'subscribe'){
                        lsInfo = `你好呀，文明君，欢迎来到垃圾分类搜easy，本宝宝旨在提供便捷的垃圾分类搜索，以及垃圾分类花边趣事 \n
                        您可
                        输入：“口诀”，查看垃圾分类的野口决；
                        输入: “互联网人”，查看互联网人的垃圾分类；
                        输入：“趣事”，查看垃圾分类趣事问答；
                        输入：“投放时间”，查看最新垃圾分类投放时间；
                        输入：您要查找的垃圾名称，例如 果皮，查看垃圾所属分类`                        
                    }
                }
